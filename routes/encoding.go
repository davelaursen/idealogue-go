...
type Encoder interface {
	...
	EncodeMultiString(v ...string) string
...
// EncodeMultiString converts a collection of strings into a JSON string (array).
func (e JSONEncoder) EncodeMultiString(v ...string) string {
